    ...
    <div className="py-4">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          A collection of useful tools for developers to streamline your
          workflow. All utilities run in your browser - no data is sent to any
          server.
        </p>
      </div>
      ...
      <div className="mt-12 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          We're constantly adding new utilities to help make your development
          workflow more efficient. Check back soon for more tools!
        </p>
      </div>
    </div>
  );
